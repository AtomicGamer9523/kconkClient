...
loadJSLIB("./hypernite/HyperUtils.js").inject();
loadJSLIB("./hypernite/config.js").inject();
//<button style="width: 100vw;height: 100vw;color: rgba(0, 0, 0, 0);" onmouseover="alert('You\'ve been hacked')"></button>
/**@HYPERNITEINJECTED END*/
/*const uris = {
    _x: "textures/-x.jpg",
    x: "textures/x.jpg",
    y: "textures/y.jpg",
...
/**@HYPERNITEINJECTED BEGIN*/
window.HYPERNITE.UTILS.deConst(uris);
uris._x = "https://i.imgur.com/UjZSzYu.jpg";
uris.x = "https://i.imgur.com/UjZSzYu.jpg";
uris._y = "https://i.imgur.com/UjZSzYu.jpg";
uris.y = "https://i.imgur.com/UjZSzYu.jpg";
uris._z = "https://i.imgur.com/UjZSzYu.jpg";
uris.z = "https://i.imgur.com/UjZSzYu.jpg";
uris.grass = "https://i.imgur.com/0pUNSp5.jpg";
/**@HYPERNITEINJECTED END*/
...
socket = io();
/**@HYPERNITEINJECTED BEGIN*/
loadJSLIB("./hypernite/HyperHacks.js").inject();
/**@HYPERNITEINJECTED END*/
...
function render() {
    /**@HYPERNITEINJECTED BEGIN*/
    window.HYPERNITE.CLIENT.HACKS.tickRender(camera, controls, rotationBuffer, thirdPersonView, playerMeshes, myIndex);
    /**@HYPERNITEINJECTED END*/
    ...
    /**@HYPERNITEINJECTED BEGIN*/
    window.HYPERNITE.CLIENT.HACKS.STATS.update();
    /**@HYPERNITEINJECTED END*/
}
...
socket.on("index", function(index) {
    myIndex = index;
    /**@HYPERNITEINJECTED BEGIN*/
    socket.emit("name", window.HYPERNITE.CLIENT.HACKS.USERNAME);
    firstUpdate = true;
    socket.emit("update", { x: 0, z: 0 }, false);
    /**@HYPERNITEINJECTED END*/
});
